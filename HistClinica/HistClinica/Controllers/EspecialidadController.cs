...
namespace HistClinica.Controllers
{
    public class EspecialidadController : Controller
    {
        ...
        public EspecialidadController(ClinicaServiceContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("idEspecialidad,codEspecialidad,codSigesa,descripcion,codSubEspecial,descSubEspecial,estado")] Especialidad especialidad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idEspecialidad,codEspecialidad,codSigesa,descripcion,codSubEspecial,descSubEspecial,estado")] Especialidad especialidad)
        {
